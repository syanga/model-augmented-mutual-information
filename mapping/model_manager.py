...
class ModelManager:
    ...
    def load_model(self, checkpoint_file="model_best.pth"):
    ...
    def process_numpy(self, input_data, checkpoint_file="model_best.pth"):
        device = self.load_model(checkpoint_file)
